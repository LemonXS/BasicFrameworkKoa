layui.define(['jquery'], function(exports) {
	...
	tree.prototype.render = function(e) {
		...
		if(e.url) {
			// console.log("【1】【2】"+e.url)
			// console.log("【1】【2】"+JSON.stringify(e))
			// console.log("【1】【2】"+JSON.stringify(e.where.CESHI))
			// console.log("【1】【2】"+e.method)
		if(	e.method!="get"){
			o.post(e.url,e.where, function(res,status) {
				e.data = res;
				t.template(e);
			})
		}else{
			o.get(e.url,e.where, function(res,status) {
				e.data = res;
				t.template(e);
			})
		}
